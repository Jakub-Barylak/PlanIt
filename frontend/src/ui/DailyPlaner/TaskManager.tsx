...
onShowTaskManagerChange}) => {
  ...
  return (
    ...
    <div className={`h-full  w-0.5 bg-${isDark  ? 'gray-500' : 'gray-200'} absolute ${showTaskManager ? 'left-[80vw]' : 'opacity-0 invisible'}  top-0 bottom-4 transition-all duration-300 z-2'}`}></div>  
